...
cat > docker/.env << EOF
MEDIA_MONITOR_ORF_API_PASSWORD=$MEDIA_MONITOR_ORF_API_PASSWORD
MEDIA_MONITOR_OPENAI_KEY=$MEDIA_MONITOR_OPENAI_KEY
MEDIA_MONITOR_YOUTUBE_KEY=$MEDIA_MONITOR_YOUTUBE_KEY
EOF
